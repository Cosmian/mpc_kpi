...
pub fn Matrix_Mul_SC<const N: u64, const L: u64, const M: u64>
    ...
    let (col,row,C)= unsafe { execute_local_function!(S_MULT_C(
        N as i64,
        L as i64,
        *A,
        L as i64,
...
pub fn Matrix_Mul_CS<const N: u64, const L: u64, const M: u64>
    ...
    let (col,row,C)= unsafe { execute_local_function!(C_MULT_S(
        N as i64,
        L as i64,
        *A,
        L as i64,
...
pub fn Gauss_Elim<const N: u64, const M: u64>
    ...
    let (col,row,B)= unsafe { execute_local_function!(GAUSS_ELIM(
        N as i64,
        M as i64,
        *A
    ) ->
